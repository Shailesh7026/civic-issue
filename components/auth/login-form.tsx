...
import { loginWithEmail, signInWithOAuth } from "@/app/actions/auth";
...
export function LoginForm({
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    if (values.staySignedIn) {
      formData.append("staySignedIn", "true");
    }
    ...
    if (result?.error) {
      if (result.error.toLowerCase().includes('email not confirmed')) {
        ...
        setGlobalError("Email Is Not Verified");
      } else {
            ...
            render={({ field }: any) => (
              <FormItem className="flex flex-row items-center gap-2">
                ...
                <FormLabel
                  ...
                  className="cursor-pointer font-normal text-muted-foreground !mt-0"
                >
